// <copyright file="DisposableObject.cs" company="Flynn1179">
...
namespace Flynn1179.Observable
{
    ...
    /// <summary>
    /// Defines a base class for an object that implements the <see cref="INotifyDisposed"/> interface.
    /// </summary>
    [Serializable]
    [ComVisible(true)]
    public abstract class DisposableObject : INotifyDisposed
    {
